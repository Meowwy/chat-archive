...
One local app that ingests Discord, Facebook Messenger and Instagram exports into a single
SQLite database and serves the whole history in a browser. Nothing leaves the machine.
